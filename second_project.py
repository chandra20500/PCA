...
vijay_2 = vijay_2.drop(columns=['Participant_name','Recording duration','Recording_timestamp'])

vijay_2 = vijay_2.drop(columns=['Recording start time'])
